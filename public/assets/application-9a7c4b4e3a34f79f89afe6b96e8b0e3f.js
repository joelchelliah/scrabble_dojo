...
(function() {
  var hide_hints, hide_words, ready, show_hints, show_words;

  hide_hints = function() {
    $('#btn-hints').text("Show hints");
    $('#box-words').removeClass('span3').addClass('span8');
    return $('#box-hints').hide();
  };

  show_hints = function() {
    $('#btn-hints').text("Hide hints");
    $('#box-words').removeClass('span8').addClass('span3');
    return $('#box-hints').show('fast');
  };

  hide_words = function() {
    $('#btn-words').text("Show words");
    return $('#box-words').hide('fast');
  };

  show_words = function() {
    $('#btn-words').text("Hide words");
    return $('#box-words').show('fast');
  };

  ready = function() {
    var current_health, max, move_left, prev_health;
    $('#box-hints').hide();
    $('#box-practice').hide();
    $('#btn-hints').click(function(e) {
      e.preventDefault();
      if (!$('#btn-hints').attr('disabled')) {
        if ($('#btn-hints').text() === "Show hints") {
          return show_hints();
        } else {
          return hide_hints();
        }
    ...
    $('#btn-practice').click(function(e) {
      ...
      if ($('#btn-practice').text() === "Practice") {
        ...
        return $('#practice-text-area').focus();
      } else {
    ...
    return $('.health-update .progress .bar').animate({
      left: '0'
    }, 2000);
  };
